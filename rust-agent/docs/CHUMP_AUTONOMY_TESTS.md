...
| **5** | Self-improve | Full self-improve cycle: read→task→edit→test→commit. | Self-improve heartbeat; "Start self-improve" in Chump Menu; scheduled loops. |
...
- Allow **self-improve heartbeat** when tier ≥ 5.
