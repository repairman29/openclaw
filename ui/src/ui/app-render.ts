        ...
        ${
          state.tab === "overview"
            ? renderOverview({
                ...
                sessionRows: state.sessionsResult?.sessions ?? [],
                channelsSnapshot: state.channelsSnapshot,
                lastChannelsRefresh: state.channelsLastSuccess,
                execApprovalQueue: state.execApprovalQueue,
                basePath: state.basePath,
                onNavigateToNodes: () => state.setTab("nodes"),
        ...
        ${
          state.tab === "chat"
            ? renderChat({
                ...
                runTimelineEntries: state.runTimelineEntries,
                splitRatio: state.splitRatio,
                onOpenSidebar: (content: string) => state.handleOpenSidebar(content),
                onCloseSidebar: () => state.handleCloseSidebar(),
                onSidebarModeChange: (mode) => state.setSidebarMode(mode),
                onPinArtifact: (artifact) => state.handlePinArtifact(artifact),
                onUnpinArtifact: (id) => state.handleUnpinArtifact(id),
